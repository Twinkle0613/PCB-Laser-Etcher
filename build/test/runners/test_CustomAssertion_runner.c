...
int main(void)
{
  ...
  RUN_TEST(test_test_assert_link_list_with_arr_the_first_parameter_is_NUll, 14);
  RUN_TEST(test_test_assert_link_list_with_arr_the_second_parameter_is_NUll, 19);
  RUN_TEST(test_test_assert_link_list_with_arr_a_few_elements_were_added_into_link_list, 24);
  RUN_TEST(test_test_assert_link_list_with_arr_one_of_the_array_value_is_not_the_same_wtih_the_value_of_linkedElement, 35);
  RUN_TEST(test_test_assert_link_list_with_arr_the_number_of_array_is_less_than_number_of_linkedlElememt, 46);
