...
extern void test_getTick_the_function_should_return_1000_2000_3000(void);
...
extern void test_DmaConfig_(void);
...
int main(void)
{
  ...
  RUN_TEST(test_motorInit_the_configuration_was_set_by_motorInit_every_setting_should_pass_the_test_, 85);
  RUN_TEST(test_setCallBack_the_callBack_of_timerElement_of_whichMotor_was_set_the_address_of_testMotor_functon_, 112);
  RUN_TEST(test_initialStepCommand_the_value_stepLowCommand_and_stepHighCommand_is_changed_to_0xAA_and_0x55, 135);
  RUN_TEST(test_getCommond_first_called_getCommand_should_return_0xAA_and_second_called_getCommand_should_retun_0x55, 144);
  RUN_TEST(test_resetMotorDriveBuffer_the_data_of_motoDriveBuffer_should_become_0, 157);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot0_the_data_of_slot0_still_can_be_update, 181);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot0_the_data_of_slot1_still_can_be_update, 212);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot0_the_data_of_slot2_still_can_be_update, 245);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot1_the_data_of_slot0_still_can_not_be_update, 277);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot1_the_data_of_slot1_still_can_be_update, 313);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot1_the_data_of_slot2_still_can_be_update, 345);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot2_the_data_of_slot0_still_can_not_be_update, 376);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot2_the_data_of_slot1_still_can_not_be_update, 406);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot2_the_data_of_slot2_still_can_be_update, 436);
  RUN_TEST(test_motorStep_the_firMotorElem_is_added_into_linked_list_the_next_of_triMotorElem_should_point_to_firMotorElem, 464);
  RUN_TEST(test_motorStep_the_secMotorElem_is_added_into_linked_list_the_next_of_triMotorElem_should_point_to_secMotorElem, 507);
  RUN_TEST(test_motorStep_Motor0Element_Motor1Element_and_Motor2Element_was_added_into_linked_list_at_the_same_time, 555);
  RUN_TEST(test_motorStep_did_not_update_slot1_but_add_the_Motor2Element_into_linked_list, 600);
  RUN_TEST(test_motorStep_when_DataNumber_is_0_the_slot2_cant_be_update_but_the_Motor2Element_was_added_into_linked_list, 648);
  RUN_TEST(test_motorStep_when_DataNumber_is_0_the_all_of_slot_cant_be_update_but_the_all_MotorElement_were_added_into_linked_list, 695);
  RUN_TEST(test_motorSet_the_motor_setting_was_set_by_using_motorSet_the_stepHighCommand_and_stepLowCommand_should_return_the_motor_setting, 727);
  RUN_TEST(test_DMA_channel_marco_the_DMAy_chanelx_that_was_executed_in_system_was_defined_into_DMA_channel_marco, 745);
  RUN_TEST(test_motorConfigInit_the_txDetail_was_set_by_motorConfigInit_the_setting_of_txDetail_should_pass_the_test, 761);
  RUN_TEST(test_extractMotorConfigInfo_, 776);
  RUN_TEST(test_dmaQueue_add_one_motorElement_into_Queue, 785);
  RUN_TEST(test_dmaQueue_add_two_motorElement_into_Queue, 795);
  RUN_TEST(test_dmaDequeue_add_two_motorElement_into_Queue_and_deQueue, 808);
  RUN_TEST(test_updateMotorDriveBuffer_the_linkedlist_only_contain_motor0Element_and_Update_the_triMotor_slot_buffer, 842);
  RUN_TEST(test_updateMotorDriveBuffer_the_linkedlist_contain_motor0Element_and_motor1Element_and_Update_the_triMotor_and_secMotor_slot_buffer, 870);
  RUN_TEST(test_updateMotorDriveBuffer_the_linkedlist_contain_motor0Element_motor1Element_and_motor2Elementent_and_Update_the_triMotor_secMotor_and_firMotor_slot_buffer, 910);
  RUN_TEST(test_updateMotorDriveBuffer_Queue_contain_motor0Element_after_function_it_should_dequeue, 952);
  RUN_TEST(test_updateMotorDriveBuffer_Queue_contain_motor0Element_motor1Element_and_motor2Element_after_function_they_should_dequeue, 985);
  RUN_TEST(test_updateMotorDriveBuffer_Queue_contain_motor0Element_and_motor2Element_after_function_they_should_dequeue, 1032);
  RUN_TEST(test_updateMotorDriveBuffer_Queue_contain_motor0Element_and_motor2Element_after_function_linkedList_contain_motor2Element, 1076);
  RUN_TEST(test_updateMotorDriveBuffer_Queue_contain_motor0Element_and_motor1Element_after_function_linkedList_is_emply, 1118);
  RUN_TEST(test_updateMotorDriveBuffer_Queue_contain_motor0Element_and_motor1Element_after_function_linkedList_only_contain_motor1Element, 1160);
  RUN_TEST(test_motorMovementHandler_the_DMA_IRQ_function_will_update_motor0Element_Command, 1205);
  RUN_TEST(test_motorMovementHandler_the_DMA_IRQ_function_was_called_in_2_times_and_the_head_of_queue_is_point_to_null, 1240);
  RUN_TEST(test_motorMovementHandler_the_DMA_IRQ_function_will_update_triMotorSlot_and_secMotorSlot_Command, 1280);
  RUN_TEST(test_motorMovementHandler_motor0Element_and_motor1Element_that_updated_completely_should_be_dequeue, 1321);
  RUN_TEST(test_motorMovementHandler_motor0Element__motor1Element_and_motor2Element_that_updated_completely_should_be_dequeue, 1371);
  RUN_TEST(test_motorMovementHandler_motor0ment_and_motor1Element_, 1427);
  RUN_TEST(test_motorMovementHandler_motor0Element_and_motor2Element_that_updated_completely_should_be_dequeue, 1500);
  RUN_TEST(test_motorMovementHandler_motor1Element_and_motor2Element_that_updated_completely_should_be_dequeue, 1552);
  RUN_TEST(test_getTick_the_function_should_return_1000_2000_3000, 1591);
  RUN_TEST(test_motorMovementHandler_the_DMA_interrupt_has_occured_two_time_the_timer_link_list_have_contained_two_element, 1614);
  RUN_TEST(test_motorMovementHandler_the1, 1709);
  RUN_TEST(test_motorMovementHandler_the_timer_link_list_has_contain_two_element_such_as_3000_and_6000, 1806);
  RUN_TEST(test_motorMovementHandler_with_3000_and_6000_elem_in_link_list, 1904);
  RUN_TEST(test_motorMovementHandler_with_1000_2000_and_4000_elem_in_timer_link_list, 2002);
  RUN_TEST(test_motorMovementHandler_with_900_800_and_4000_elem_in_timer_link_list, 2111);
  RUN_TEST(test_motorMovementHandler_with_1_9_and_90_elem_in_timer_link_list, 2221);
  RUN_TEST(test_getNewPeriod_tickInterval_is_10_and_initial_period_is_20_the_function_should_return_10, 2375);
  RUN_TEST(test_getNewPeriod_tickInterval_is_10_and_initial_period_is_5_the_function_should_return_1, 2385);
  RUN_TEST(test_getNewPeriod_tickInterval_is_10_and_initial_period_is_10_the_function_should_return_1, 2395);
  RUN_TEST(test_DmaConfig_, 2405);
