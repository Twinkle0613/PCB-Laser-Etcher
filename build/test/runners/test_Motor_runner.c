...
int main(void)
{
  ...
  RUN_TEST(test_motorInit_the_configuration_was_set_by_motorInit_every_setting_should_pass_the_test_, 89);
  RUN_TEST(test_setCallBack_the_callBack_of_timerElement_of_whichMotor_was_set_the_address_of_testMotor_functon_, 116);
  RUN_TEST(test_initialStepCommand_the_value_stepLowCommand_and_stepHighCommand_is_changed_to_0xAA_and_0x55, 139);
  RUN_TEST(test_getCommond_first_called_getCommand_should_return_0xAA_and_second_called_getCommand_should_retun_0x55, 148);
  RUN_TEST(test_resetMotorDriveBuffer_the_data_of_motoDriveBuffer_should_become_0, 161);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot0_the_data_of_slot0_still_can_be_update, 185);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot0_the_data_of_slot1_still_can_be_update, 216);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot0_the_data_of_slot2_still_can_be_update, 249);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot1_the_data_of_slot0_still_can_not_be_update, 281);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot1_the_data_of_slot1_still_can_be_update, 317);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot1_the_data_of_slot2_still_can_be_update, 349);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot2_the_data_of_slot0_still_can_not_be_update, 380);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot2_the_data_of_slot1_still_can_not_be_update, 410);
  RUN_TEST(test_motorStep_when_DmaPointer_point_to_slot2_the_data_of_slot2_still_can_be_update, 440);
  RUN_TEST(test_motorStep_the_firMotorElem_is_added_into_linked_list_the_next_of_triMotorElem_should_point_to_firMotorElem, 468);
  RUN_TEST(test_motorStep_the_secMotorElem_is_added_into_linked_list_the_next_of_triMotorElem_should_point_to_secMotorElem, 511);
  RUN_TEST(test_motorStep_Motor0Element_Motor1Element_and_Motor2Element_was_added_into_linked_list_at_the_same_time, 559);
  RUN_TEST(test_motorStep_did_not_update_slot1_but_add_the_Motor2Element_into_linked_list, 604);
  RUN_TEST(test_motorStep_when_DataNumber_is_0_the_slot2_cant_be_update_but_the_Motor2Element_was_added_into_linked_list, 652);
  RUN_TEST(test_motorStep_when_DataNumber_is_0_the_all_of_slot_cant_be_update_but_the_all_MotorElement_were_added_into_linked_list, 699);
  RUN_TEST(test_motorSet_the_motor_setting_was_set_by_using_motorSet_the_stepHighCommand_and_stepLowCommand_should_return_the_motor_setting, 731);
  RUN_TEST(test_DMA_channel_marco_the_DMAy_chanelx_that_was_executed_in_system_was_defined_into_DMA_channel_marco, 749);
  RUN_TEST(test_motorConfigInit_the_txDetail_was_set_by_motorConfigInit_the_setting_of_txDetail_should_pass_the_test, 765);
  RUN_TEST(test_extractMotorConfigInfo_, 780);
  RUN_TEST(test_dmaQueue_add_one_motorElement_into_Queue, 789);
  RUN_TEST(test_dmaQueue_add_two_motorElement_into_Queue, 799);
  RUN_TEST(test_dmaDequeue_add_two_motorElement_into_Queue_and_deQueue, 812);
  RUN_TEST(test_updateMotorDriveBuffer_the_linkedlist_only_contain_motor0Element_and_Update_the_triMotor_slot_buffer, 846);
  RUN_TEST(test_updateMotorDriveBuffer_the_linkedlist_contain_motor0Element_and_motor1Element_and_Update_the_triMotor_and_secMotor_slot_buffer, 874);
  RUN_TEST(test_updateMotorDriveBuffer_the_linkedlist_contain_motor0Element_motor1Element_and_motor2Elementent_and_Update_the_triMotor_secMotor_and_firMotor_slot_buffer, 914);
  RUN_TEST(test_updateMotorDriveBuffer_Queue_contain_motor0Element_after_function_it_should_dequeue, 956);
  RUN_TEST(test_updateMotorDriveBuffer_Queue_contain_motor0Element_motor1Element_and_motor2Element_after_function_they_should_dequeue, 989);
  RUN_TEST(test_updateMotorDriveBuffer_Queue_contain_motor0Element_and_motor2Element_after_function_they_should_dequeue, 1036);
  RUN_TEST(test_updateMotorDriveBuffer_Queue_contain_motor0Element_and_motor2Element_after_function_linkedList_contain_motor2Element, 1080);
  RUN_TEST(test_updateMotorDriveBuffer_Queue_contain_motor0Element_and_motor1Element_after_function_linkedList_is_emply, 1122);
  RUN_TEST(test_updateMotorDriveBuffer_Queue_contain_motor0Element_and_motor1Element_after_function_linkedList_only_contain_motor1Element, 1164);
  RUN_TEST(test_motorMovementHandler_the_DMA_IRQ_function_will_update_motor0Element_Command, 1209);
  RUN_TEST(test_motorMovementHandler_the_DMA_IRQ_function_was_called_in_2_times_and_the_head_of_queue_is_point_to_null, 1244);
  RUN_TEST(test_motorMovementHandler_the_DMA_IRQ_function_will_update_triMotorSlot_and_secMotorSlot_Command, 1284);
  RUN_TEST(test_motorMovementHandler_motor0Element_and_motor1Element_that_updated_completely_should_be_dequeue, 1325);
  RUN_TEST(test_motorMovementHandler_motor0Element__motor1Element_and_motor2Element_that_updated_completely_should_be_dequeue, 1375);
  RUN_TEST(test_motorMovementHandler_motor0ment_and_motor1Element_, 1431);
  RUN_TEST(test_motorMovementHandler_motor0Element_and_motor2Element_that_updated_completely_should_be_dequeue, 1504);
  RUN_TEST(test_motorMovementHandler_motor1Element_and_motor2Element_that_updated_completely_should_be_dequeue, 1556);
  RUN_TEST(test_getFakeTick, 1596);
  RUN_TEST(test_getTick, 1606);
  RUN_TEST(test_motorMovementHandler_the_DMA_interrupt_has_occured_two_time_the_timer_link_list_have_contained_two_element, 1629);
  RUN_TEST(test_motorMovementHandler_the1, 1724);
  RUN_TEST(test_motorMovementHandler_the_timer_link_list_has_contain_two_element_such_as_3000_and_6000, 1821);
  RUN_TEST(test_motorMovementHandler_with_3000_and_6000_elem_in_link_list, 1919);
  RUN_TEST(test_motorMovementHandler_with_1000_2000_and_4000_elem_in_timer_link_list, 2017);
  RUN_TEST(test_motorMovementHandler_with_900_800_and_4000_elem_in_timer_link_list, 2126);
  RUN_TEST(test_motorMovementHandler_with_1_9_and_90_elem_in_timer_link_list, 2236);
  RUN_TEST(test_getNewPeriod_tickInterval_is_10_and_initial_period_is_20_the_function_should_return_10, 2390);
  RUN_TEST(test_getNewPeriod_tickInterval_is_10_and_initial_period_is_5_the_function_should_return_1, 2400);
  RUN_TEST(test_getNewPeriod_tickInterval_is_10_and_initial_period_is_10_the_function_should_return_1, 2410);
